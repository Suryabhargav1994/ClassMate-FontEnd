...
export class ApiService {
  ...
  public listOfAccom(id: any) {
    ...
    return this.httpservice.post(
      "http://127.0.0.1:9000/roommate/acc-list",
      payload
    );
  }
  ...
  public aminity(aminity: any) {
    ...
    return this.httpservice.post(
      "http://127.0.0.1:9000/roommate/aminity-registry",
      payload
    );
  }
  ...
  public accomadationRegister(acc: any) {
    const payload = {
      ...
      furnituredname: acc.furnituredname,
      person_id: localStorage.getItem("UserId"),
    };
    return this.httpservice.post(
      "http://127.0.0.1:9000//roommate/accommodation-register",
      payload
    );
  }
  ...
  public accUniLink(uniLink: any) {
    return this.httpservice.post(
      "http://127.0.0.1:9000/roommate/acc-uni-map",
      uniLink
    );
  }
  ...
  public booking(acc_id?: any) {
    ...
    return this.httpservice.post(
      "http://127.0.0.1:9000/roommate/booking-room",
      payload
    );
  }

  public getUserDetails(personId: any) {
    const payload = { person_id: personId };
    return this.httpservice.post<any>(
      "http://127.0.0.1:9000/roommate/account-details",
      payload
    );
  }
  ...
  public deleteAccommodation(accommodationId: string) {
    const payload = {
      accomidation_id: accommodationId,
    };
    return this.httpservice.post(
      "http://127.0.0.1:9000/roommate/delete-accomidation",
      payload
    );
  }
}
